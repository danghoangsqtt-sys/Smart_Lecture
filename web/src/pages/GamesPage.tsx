...
function SimulationChallengesField({
  ...
  return (
    <div className="mt-3 rounded-sm border border-slate-200 bg-slate-50 p-3">
      ...
      {challenges.length === 0 ? (
        <p className="text-[10px] italic leading-relaxed text-slate-400">Bỏ trống để dùng bộ 3 thử thách mẫu <b>Đèn LED · Cổng AND · Mạch NOT</b> — đã có sẵn mạch tham chiếu, chấm tự động.</p>
      ) : (
